...
import { ArrowUpRight, TrendingUp, Smartphone, Search } from 'lucide-react';

export default function ProjectCard({ title, description, image, stats }: any) {
  const [isFlipped, setIsFlipped] = useState(false);

  return (
    <div className="flex flex-col gap-6 w-full mb-24 cursor-pointer group" onClick={() => setIsFlipped(!isFlipped)}>
      <div className="relative w-full aspect-[4/3] md:aspect-[21/9] perspective-1000">
        <motion.div
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        ...
        <div className="flex flex-col items-end gap-2">
          ...
          <span className="text-[10px] font-sans uppercase tracking-widest text-[#e6e2d3] border-b border-[#e6e2d3]/30 pb-1 flex items-center gap-1 group-hover:text-[#c4a277] group-hover:border-[#c4a277]/50 transition-colors">
